...
expected_cols = {
    % --- Identifiers & High-Level Config ---
    'level', 'query_id', 'segment_id', ...
    'emb_config', 'weight_mode', 'dtw_mode', ...
    
    % --- Metrics: DTW vs Embedding (Approximation Quality) ---
    'spearman_dtw_eb', ...
    'ndcg_10_dtw_eb', 'ndcg_50_dtw_eb', ...
    'r1_dtw_eb', 'r5_dtw_eb', 'r10_dtw_eb', 'r50_dtw_eb', ...
    'p_at_50_dtw_eb', ...
    
    % --- Metrics: GT vs Embedding (Filter Safety/Performance) ---
    'ndcg_10_gt_eb', 'ndcg_50_gt_eb', 'mrr_gt_eb', ...
    'r1_gt_eb', 'r5_gt_eb', 'r10_gt_eb', 'r50_gt_eb', ...
    'mean_rank_gt_eb', ...
    
    % --- Metrics: GT vs DTW (Comparison Baseline) ---
    'ndcg_10_gt_dtw', 'ndcg_50_gt_dtw', 'mrr_gt_dtw', ...
    'r1_gt_dtw', 'r5_gt_dtw', 'r10_gt_dtw', 'r50_gt_dtw', ...
    'mean_rank_gt_dtw', ...
    
    % --- Meta ---
    'num_gt', ...

    % --- Detailed Config / Hyperparameters (NEU) ---
    'n_coarse', 'n_fine', 'top_k', ...
    'database_size', 'num_trajectories', 'num_segments', ...
    'lb_kim_ratio', 'lb_keogh_n', ...
    'dtw_normalize', 'dtw_rot_align', ...
    'timestamp'
};
