...
matrix_date = '10.04.2025';

% Transformationsmatrizen vom Lasertracker
% Offset vom gemessenen Punkt zum TCP (Tool Center Point)
try
    [offset_matrix, robot_to_instrument] = findTransfMatrices(matrix_date);
catch ME
    error('Fehler beim Laden der Transformationsmatrizen: %s', ME.message);
end
