function [table_euclidean_info, table_sidtw_info, table_dtw_info, table_dfd_info, table_lcss_info, ...
    ...
    if strcmpi(data_source, 'leica_at960')
        ...
        if ~isempty(check_transf)
            ...
            positions_transformed = table2array(data_trans(:,4:6));     % Transformierte Position [x, y, z]
            q_transformed = table2array(data_trans(:,7:10));            % Transformierte Quaternion [qx, qy, qz, qw]
